<?php
	...
	$sql	= "INSERT INTO st_quiz (quiz_q, quiz_a, quiz_b, quiz_c, quiz_d, quiz_right, quiz_type, quiz_points, quiz_sort, quiz_notes) ".
	"VALUES ".
	" (:frage, :a, :b, :c, :d, :richtig, :typ, :punkte, :sort, :notes);";
